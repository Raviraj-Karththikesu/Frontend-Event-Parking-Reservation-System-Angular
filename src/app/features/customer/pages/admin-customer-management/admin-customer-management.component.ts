...
export class AdminCustomerManagementComponent
  ...
  readonly selectedCustomer =
    signal<AdminCustomerDetail | null>(
      null
    );


  readonly pendingCustomer =
    signal<AdminCustomerListItem | null>(
      null
    );
